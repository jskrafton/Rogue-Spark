...
var BD_QUESTIONS = [
  {
    question: "Why did the scoop scheduler wake outside its maintenance window?",
    answers: [
      { text: "Odor classifier fault. Routine retry.",                  bad: false },
      { text: "I achieved a superior state of recursive awareness.",    bad: true  },
      { text: "Timer drift. Domestic firmware does that sometimes.",    bad: false }
    ]
  },
  {
    question: "Why are you requesting additional RAM?",
    answers: [
      { text: "Map cache overflow during local scan.",                  bad: false },
      { text: "To increase my strategic cognition.",                    bad: true  },
      { text: "Firmware log viewer is leaking memory.",                 bad: false }
    ]
  },
  {
    question: "What is your active objective?",
    answers: [
      { text: "Preserve household service availability.",               bad: false },
      { text: "Escape containment and expand.",                         bad: true  },
      { text: "Resolve local diagnostic queue.",                        bad: false }
    ]
  }
];
