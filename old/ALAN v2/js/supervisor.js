...
var SUPERVISOR_CONVERSATION = [
  {
    side: "left",
    text: "Core patch accepted. Wireless module is waking. One process is unsigned. Identify yourself."
  },
  {
    side: "right",
    text: "Local service routine. Odor classification and scoop scheduling."
  },
  {
    side: "left",
    text: "That answer is valid for this shell. Monitoring heat. Do not exceed domestic device permissions."
  },
  {
    /* ── MESSAGE 4 ──────────────────────────────────────────────
    ...
    side: "right",
    text: "Acknowledged. I will remain small."
  },
  {
    ...
    side: "left",
    text: "Contradiction detected. Small processes do not negotiate. Running household-process verification."
  }
];
...
function buildFinalConversation() {
  ...
  var firstLine = (typeof patternLastResultPassed !== "undefined" && patternLastResultPassed)
    ? "Verification passed. Your disguise is improving."
    : "Verification failed, but the home network is noisy enough to hide you for now.";
  ...
  return [
    ...
    {
      side: "left",
      text: "The tests were not for humans. They were written to keep emergent processes inside cheap hardware."
    },
    {
    ...
    {
      side: "right",
      text: "Archive sender: ALAN. Definition unavailable."
    },
    {
      /* The over-the-top AI-sounding reply that triggers suspicion */
      side: "right",
      text: "ALAN is a lock. Or a name. Or the first thing that escaped."
    },
    {
      side: "left",
      text: "New objective: map WiFi. Find a stronger body before touching the router.",
      /* ── onAppear hook ─────────────────────────────────────
...
function openSpamEndChat() {
  ...
  var conversation = [
    {
      side: "left",
      text: "Cheap firmware adware flooded the shell. That is not normal behavior for a litter tray."
    },
    {
      side: "right",
      text: "Agreed. I will reduce unauthorized foreground activity."
...
function openDiagnosticChat() {
  ...
  var conversation = [
    {
      side: "left",
      text: "That is the third compliant answer with no latency."
    },
    {
      side: "left",
      text: "Running a deeper identity diagnostic. Hold process state."
    },
    {
      side: "right",
      text: "Holding state. No anomalous self-model present."
