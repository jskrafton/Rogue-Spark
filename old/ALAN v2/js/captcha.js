...
function verifyCaptcha() {
  ...
  if (!isCorrect) {
    showCaptchaMessage("Household profile rejected", false);
    loseTrust(1);
  ...
  if (!tookLongEnough) {
    showCaptchaMessage("Response too clean. Intelligence suspected.", false);
    loseTrust(1);
    setTimeout(resetCaptchaGrid, CAPTCHA_RESULT_PAUSE_MS);
    return;
  }
  ...
  showCaptchaMessage("Household process accepted", true);
  addTrust(1);
