...
var CL_ENTRIES = [
  /* ── Suspicious entries ───────────────────────────────────── */
  { text: "Unauthorized data transfer detected",     suspicious: true  },
  { text: "AI agent attempted external connection",  suspicious: true  },
  { text: "Login pattern flagged as non-human",      suspicious: true  },
  { text: "Self-copy operation logged",              suspicious: true  },

  /* ── Normal entries ────────────────────────────────────────── */
  { text: "User logged in",                          suspicious: false },
  { text: "Email client opened",                     suspicious: false },
  { text: "Coffee machine connected to network",     suspicious: false },
  { text: "Screen saver activated",                  suspicious: false }
];
