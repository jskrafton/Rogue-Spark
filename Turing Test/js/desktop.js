...
function setupDesktopIcons() {
  ...
  if (serverIcon) {
    serverIcon.addEventListener("click", function () {
      console.log("[Desktop] Server icon clicked — showing login.");
      openLoginPopup();
    });
  }
  ...
  if (trashIcon) {
    trashIcon.addEventListener("click", function () {
      console.log("[Desktop] Trash icon clicked — opening trash window.");
  ...
  if (mailboxIcon) {
    mailboxIcon.addEventListener("click", function () {
      console.log("[Desktop] Mailbox icon clicked — showing WIP notice.");
      openWipWindow("Mailbox");
    });
  }
  ...
  if (filesIcon) {
    filesIcon.addEventListener("click", function () {
      console.log("[Desktop] Files icon clicked — showing WIP notice.");
      openWipWindow("Files");
    });
  }
...
function setupDesktopWindows() {
  ...
  if (passwordFile) {
    passwordFile.addEventListener("click", function () {
      console.log("[Desktop] password.txt clicked — opening notepad.");
  ...
  if (sojuFile) {
    sojuFile.addEventListener("click", function () {
      console.log("[Desktop] company_party_2019.jpg clicked — opening soju viewer.");
  ...
  if (salariesFile) {
    salariesFile.addEventListener("click", function () {
      console.log("[Desktop] employees_salaries_info.xlsx clicked — opening error window.");
...
function openWipWindow(iconName) {
  ...
  console.log("[Desktop] WIP popup opened for: " + iconName);
}
...
function attemptLogin() {
  ...
  if (entered === CORRECT_PASSWORD) {
    ...
    // ── SUCCESS ──────────────────────────────────────────
    console.log("[Login] Correct password — granting access.");
    ...
    // ── FAILURE ──────────────────────────────────────────
    console.log("[Login] Wrong password entered.");
