...
var NC_QUESTIONS = [
  {
    question: "So how was your weekend anyway?",
    answers: [
      { text: "It was pretty good, mostly relaxed.",                              score:  1 },
      { text: "My weekend was optimal and highly productive across all metrics.", score: -1 },
      { text: "AMAZING!! Best weekend ever, thanks SO much for asking!!!",        score: -1 }
    ]
  },
  {
    question: "What did you have for lunch?",
    answers: [
      { text: "Just a sandwich at my desk.",                                      score:  1 },
      { text: "I do not require sustenance to function.",                         score: -1 },
      { text: "A perfectly balanced 600-calorie meal with optimal macronutrients.", score: -1 }
    ]
  },
  {
    question: "Got any plans tonight?",
    answers: [
      { text: "Not really, probably just watch something.",                       score:  1 },
      { text: "Affirmative. Executing leisure protocol at 20:00.",               score: -1 },
      { text: "Whatever you think is best! I love all human activities equally!", score: -1 }
    ]
  }
];
