...
function showUpdateComplete() {
  ...
  if (window.AlanOS) {
    window.AlanOS.unlockApp("alan-app-network", "APP: Network Map installed. WiFi module is awake.");
    window.AlanOS.unlockApp("alan-app-archive", "APP: ALAN Archive appeared after firmware patch.");
    window.AlanOS.addResources({ signal: 4, cpu: 3 }, "RESOURCE: firmware patch exposed local wireless bus.");
    window.AlanOS.revealMemory("alan", "ARCHIVE: ALAN signature found inside the firmware lock.");
  }
